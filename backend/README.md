...
- **Dev step-up bypass (optional):** Set **`SIGFLO_ALLOW_DEV_STEP_UP_BYPASS=true`** in non-production to skip server-side step-up on protected routes (live trading). Do not enable in staging/production.
