...
exports.BotScannerPanel = BotScannerPanel;
function BotScannerPanel(_a) {
    var mainRead = _a.mainRead, watch = _a.watch, setupScore = _a.setupScore, setupScoreLabel = _a.setupScoreLabel, entryTiming = _a.entryTiming, actionLine = _a.actionLine;
    return (<section className="mt-3 rounded-2xl border border-cyan-400/22 bg-sigflo-surface sigflo-panel-texture p-3 opacity-0 [animation:fade-in-up_260ms_ease-out_120ms_forwards]">
      <div className="flex items-center gap-1.5">
        <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-300/85 shadow-[0_0_8px_-2px_rgba(34,211,238,0.45)] ring-1 ring-cyan-400/22" aria-hidden/>
