...
export type EngineDetailControlsProps = {
...
export function EngineDetailControls({
  isPausedLocally,
  onPauseToggle,
  onViewForming,
  onBackToBots,
}: EngineDetailControlsProps) {
  return (
    <section className="rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-3 backdrop-blur-sm">
