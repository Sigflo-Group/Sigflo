...
exports.EngineHeaderCard = EngineHeaderCard;
...
function EngineHeaderCard(_a) {
    var engine = _a.engine, isPausedLocally = _a.isPausedLocally;
    var displayState = isPausedLocally ? 'Paused' : engine.state;
    return (<section className="rounded-2xl border border-white/10 bg-white/[0.035] px-4 py-3.5 backdrop-blur-sm">
