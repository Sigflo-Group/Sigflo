...
exports.TradeSummaryCard = TradeSummaryCard;
function fmtSignedPnl(n) {
...
function TradeSummaryCard(_a) {
    var model = _a.model, market = _a.market;
    var livePnlClass = model.livePnlUsd >= 0 ? 'text-emerald-400' : 'text-rose-400';
    return (<div className="rounded-2xl border border-white/[0.06] bg-sigflo-surface sigflo-panel-texture p-2.5 space-y-2">
      ...
      <div className="flex items-center justify-between text-xs">
        ...
        <span className={"font-bold tabular-nums ".concat(livePnlClass)}>
      ...
      {market === 'futures' && (<div className="flex items-center justify-between text-xs">
