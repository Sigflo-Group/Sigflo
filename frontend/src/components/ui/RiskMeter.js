...
function RiskMeter(_a) {
    ...
    return (<div className="space-y-1">
      <div className="relative h-2 overflow-hidden rounded-full bg-white/[0.06]">
        ...
        <div className={"absolute top-1/2 h-3 w-3 -translate-y-1/2 rounded-full border border-white/80 ".concat(markerColor[level])} style={{ left: "calc(".concat(pct, "% - 6px)") }}/>
      </div>
